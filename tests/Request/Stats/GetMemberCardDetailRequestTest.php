 ...
 * @internal
 */
#[CoversClass(GetMemberCardDetailRequest::class)]
final class GetMemberCardDetailRequestTest extends RequestTestCase
{
    ...
    {
        $this->assertEquals('https://api.weixin.qq.com/datacube/getcardmembercarddetail', $this->request->getRequestPath());
    }
