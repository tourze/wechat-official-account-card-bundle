 ...
 * @internal
 */
#[CoversClass(GetBizuinInfoRequest::class)]
final class GetBizuinInfoRequestTest extends RequestTestCase
{
    ...
    {
        $this->assertEquals('https://api.weixin.qq.com/datacube/getcardbizuininfo', $this->request->getRequestPath());
    }
